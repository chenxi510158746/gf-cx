...
// UsersDao is the data access object for table c_users.
...
// UsersColumns defines and stores column names for table c_users.
...
// usersColumns holds the columns for table c_users.
